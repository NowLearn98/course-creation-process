        ...
        <Tabs defaultValue="overview" className="space-y-8">
          ...
          <TabsContent value="survey" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <StatCard label="Total Responses" value={11} icon={ClipboardList} accent="blue" />
              <StatCard label="Avg Instructor Rating" value="4.2 / 5" icon={Star} accent="amber" />
              <StatCard label="Avg Student Rating" value="4.3 / 5" icon={Star} accent="emerald" />
            </div>
                        ...
                        <div className="flex items-start justify-between gap-3">
                          <div className="flex items-center gap-3 min-w-0">
                            <Avatar className="h-10 w-10 shrink-0">
                              <AvatarFallback className="bg-primary/10 text-primary text-sm font-semibold">
                                {survey.name.split(" ").map(n => n[0]).join("")}
                              </AvatarFallback>
                            </Avatar>
                            <div className="min-w-0">
                          ...
                          <div className="flex items-center gap-2 shrink-0">
                            <div className="flex gap-0.5">
                              {[1,2,3,4,5].map(i => (
                                <Star key={i} className={`w-4 h-4 ${i <= survey.rating ? "fill-amber-400 text-amber-400" : "text-muted-foreground/30"}`} />
                              ))}
                            </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-2">
                          <div className="flex gap-0.5">
                            {[1,2,3,4,5].map(i => (
                              <Star key={i} className={`w-4 h-4 ${i <= surveyProfileDialog.rating ? "fill-amber-400 text-amber-400" : "text-muted-foreground/30"}`} />
                            ))}
                          </div>
                          <span className="text-sm font-semibold">{surveyProfileDialog.rating}/5</span>
                        </div>
                      </div>
                      <div className="flex justify-between items-center">
